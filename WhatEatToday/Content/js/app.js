...
$(function () {
    var numberSelections = $('.number-selector5 > div > div');
    var combinationsInputs = $('.combinations-input');
    var copyButtons = $('.copy-button');
...
$(function () {
    var numberSelections = $('.number-selector6 > div > div');
    var combinationsInputs = $('.combinations-input');
    var copyButtons = $('.copy-button');
...
$(function () {
    var numberSelections = $('.number-selector7 > div > div');
    var combinationsInputs = $('.combinations-input');
    var copyButtons = $('.copy-button');
...
$(function () {
    var numberSelections = $('.number-selector8 > div > div');
    var combinationsInputs = $('.combinations-input');
    var copyButtons = $('.copy-button');
...
$(function () {
    var numberSelections = $('.number-selector9 > div > div');
    var combinationsInputs = $('.combinations-input');
    var copyButtons = $('.copy-button');
